...
// const [id, setId] = useState('CS101')
// const [cap, setCap] = useState(120)
// const [msg, setMsg] = useState('')
// async function save() {
// await repo.update(id, { capacity: { enrolled: 0, total: cap } })
// setMsg('Saved! (approval workflow omitted in mock)')
// }
// return (
// <div className="grid gap-3 max-w-lg">
// <h2 className="text-lg font-semibold">Admin — Edit Course Capacity</h2>
// <input className="border p-2 rounded" value={id} onChange={e => setId(e.target.value)} />
// <input className="border p-2 rounded" type="number" value={cap} onChange={e => setCap(Number(e.target.value))} />
...
export default function AdminPage({ setRole }) {
  ...
  return (
    <div className="container admin">
      {/* Sidebar */}
      <aside className="sidebar" style={{ zIndex: 100, maxWidth: "250px" }}>
        ...
        <nav className="sidebar-nav">
          ...
          <ul>
            ...
            <li className="nav-item" tabIndex={0}>
              <img src="/src/img/user.png" alt="users" />
              Users
            </li>
            <li className="nav-item" tabIndex={0}>
            ...
            <li
              ...
              style={{ color: "#f25757" }}
            >
              <FontAwesomeIcon icon={faSignIn} /> log out
            </li>
          </ul>
        </nav>
      ...
      <main className="main-content">
        <header className="main-header">
          <div className="header-actions">
            <button
              ...
              title="Notifications"
              onClick={() => alert("Go to notifications page")}
            >
              <img src="/src/img/notification.png" alt="notifications" />
            </button>
          </div>
          <div className="search-container">
            <input
              ...
              autoComplete="off"
            />
            <button className="btn sync-btn" title="search">
              Search
            </button>
          </div>
        </header>
        ...
        <div className="course">
          ...
          <table className="courses-table" role="grid">
            <thead>
              <tr>
                <th>ID</th>
                <th>Course</th>
            ...
            <tbody>
              <tr>
                ...
                <td>Mon/Wed 10:00</td>
                <td>
                  <span className="capacity-label green">24/30</span>
                </td>
                <td>
                  <button className="btn small-btn">Edit</button>
                  <button
                    className="btn small-btn2"
