...
class UserServiceTester:
    ...
    def test_get_user(self):
        ...
        try:
            response = requests.get(f"{self.base_url}/api/v1/users/{self.created_user_id}")
            print(f"Status: {response.status_code}")
    ...
    def test_activate_user(self):
        ...
        try:
            response = requests.post(f"{self.base_url}/api/v1/users/{self.created_user_id}/activate")
            print(f"Status: {response.status_code}")
    ...
    def test_update_user(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   New name: {data['user']['first_name']} {data['user']['last_name']}")
                return True
            else:
